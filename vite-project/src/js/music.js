function music() {
        ...
        const musicListClose = musicWrap.querySelector(
        ...
        `;
                ...
                //리스트에 음악 시간 불러오기
                let liAudioDuraion = musicListUl.querySelector(
                        `#${allMusic[i].audio}`
                ); //리스트에서 시간을 표시할 선택자
                let liAudio = musicListUl.querySelector(
                        `.${allMusic[i].audio}`
                ); //리스트에서 오디오 파일 선택자
        ...
        function playListMusic() {
                ...
                for (let i = 0; i < musicListAll.length; i++) {
                        ...
                        if (musicListAll[i].classList.contains("playing")) {
                                ...
                                let dataAudioDuration =
                                        audioTag.getAttribute("data-duration");
                                audioTag.innerText = dataAudioDuration;
                        }
                        if (
                                musicListAll[i].getAttribute("data-index") ==
                                musicIndex
                        ) {
